...
def get_Strided(op_type, m, n, feat_size = 32):
    """Ref: https://github.com/STile-project/STile/blob/ac0518bae2a3bee917cd673638565f602eaa5fa9/MY_sparse/gen_formats_v2.py#L2970
    """
    indices = list()
    s = int(n**0.5)
    for i in range(m):
...
if __name__ == "__main__":
    ...
    for num_features in [32, 64, 128, 256, 512]:
        ...
        g = MTX(None)
        g.name = name
        g.coo_mtx, _ = get_Strided('spmm', m=4096, n=4096, feat_size=num_features)
