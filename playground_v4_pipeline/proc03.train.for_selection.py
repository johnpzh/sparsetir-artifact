...
def train_and_infer(train_file: str,
    ...
    X_train, y_train = utils.get_X_and_y_v1_value(train_file)
    X_infer, y_truth = utils.get_X_and_y_v1_value(infer_file)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Train models for format selection")
