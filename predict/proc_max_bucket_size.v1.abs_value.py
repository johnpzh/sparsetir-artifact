...
def train_and_infer(train_file: str,
    ...
    X_train, y_train = utils.get_X_value_and_y_max_bucket_size(train_file)
    X_infer, y_truth = utils.get_X_value_and_y_max_bucket_size(infer_file)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("predict number of partitions")
