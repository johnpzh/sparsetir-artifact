  ...
  if (((int)blockIdx.x) < 14) {
    for (int i_0_0_1 = 0; i_0_0_1 < 16; ++i_0_0_1) {
      ...
      for (int k2_init = 0; k2_init < 2; ++k2_init) {
        if (((((int)blockIdx.x) * 2) + (i_0_0_1 >> 3)) < 27) {
    ...
    if (((int)blockIdx.x) < 22) {
      for (int i_0_1_1 = 0; i_0_1_1 < 4; ++i_0_1_1) {
        #pragma unroll
        for (int k2_init1 = 0; k2_init1 < 2; ++k2_init1) {
          if ((((((int)blockIdx.x) * 16) + (i_0_1_1 * 4)) + (((int)threadIdx.y) >> 1)) < 349) {
            C[((((I_0_1_indices_data[((((((int)blockIdx.x) * 32) + (i_0_1_1 * 8)) + ((int)threadIdx.y)) - 448)] * 512) + (((int)blockIdx.y) * 64)) + (k2_init1 * 32)) + ((int)threadIdx.x))] = 0.000000e+00f;
          }
        }
        #pragma unroll
        for (int j_0_1 = 0; j_0_1 < 64; ++j_0_1) {
          ...
          for (int k21 = 0; k21 < 2; ++k21) {
            if ((((((int)blockIdx.x) * 16) + (i_0_1_1 * 4)) + (((int)threadIdx.y) >> 1)) < 349) {
              C[((((I_0_1_indices_data[((((((int)blockIdx.x) * 32) + (i_0_1_1 * 8)) + ((int)threadIdx.y)) - 448)] * 512) + (((int)blockIdx.y) * 64)) + (k21 * 32)) + ((int)threadIdx.x))] = (C[((((I_0_1_indices_data[((((((int)blockIdx.x) * 32) + (i_0_1_1 * 8)) + ((int)threadIdx.y)) - 448)] * 512) + (((int)blockIdx.y) * 64)) + (k21 * 32)) + ((int)threadIdx.x))] + (A_0_1[(((((((int)blockIdx.x) * 2048) + (i_0_1_1 * 512)) + (((int)threadIdx.y) * 64)) + j_0_1) - 28672)] * B[((((J_0_1_indices_data[(((((((int)blockIdx.x) * 2048) + (i_0_1_1 * 512)) + (((int)threadIdx.y) * 64)) + j_0_1) - 28672)] * 512) + (((int)blockIdx.y) * 64)) + (k21 * 32)) + ((int)threadIdx.x))]));
            }
          }
        }
      }
      ...
      for (int k2_init2 = 0; k2_init2 < 2; ++k2_init2) {
        if (((((int)blockIdx.x) * 8) + ((int)threadIdx.y)) < 199) {
          C_local[k2_init2] = 0.000000e+00f;
        }
      }
      #pragma unroll
      for (int j_0_2 = 0; j_0_2 < 256; ++j_0_2) {
        #pragma unroll
        for (int k22 = 0; k22 < 2; ++k22) {
          if (((((int)blockIdx.x) * 8) + ((int)threadIdx.y)) < 199) {
            C_local[k22] = (C_local[k22] + (A_0_2[((((((int)blockIdx.x) * 2048) + (((int)threadIdx.y) * 256)) + j_0_2) - 45056)] * B[((((J_0_2_indices_data[((((((int)blockIdx.x) * 2048) + (((int)threadIdx.y) * 256)) + j_0_2) - 45056)] * 512) + (((int)blockIdx.y) * 64)) + (k22 * 32)) + ((int)threadIdx.x))]));
          }
        }
      }
      for (int ax2 = 0; ax2 < 2; ++ax2) {
        if (((((int)blockIdx.x) * 8) + ((int)threadIdx.y)) < 199) {
          atomicAdd(C + ((((I_0_2_indices_data[(((((int)blockIdx.x) * 8) + ((int)threadIdx.y)) - 176)] * 512) + (((int)blockIdx.y) * 64)) + (ax2 * 32)) + ((int)threadIdx.x)), C_local[ax2]);
        }
      }
    }
  }
