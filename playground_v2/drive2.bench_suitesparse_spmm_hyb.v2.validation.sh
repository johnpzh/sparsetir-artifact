...
app="bench_suitesparse_spmm_hyb.v2.validation.py"
...
verbose_file="${output_dir}/output_0_suitesparse_hyb_verbose.log"
:> "${verbose_file}"
...
python "${app}" -d "${mtx_file}" -i 2>&1 | tee -a "${verbose_file}"
