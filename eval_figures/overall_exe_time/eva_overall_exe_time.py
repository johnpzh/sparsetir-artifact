...
if __name__ == "__main__":
    ...
    axs.bar_label(rects4, fmt="%0.2f", padding=3, color=colors[3], fontsize=fontsize, rotation=90)
    axs.bar_label(rects5, fmt="%0.2f", padding=3, color=colors[4], fontsize=fontsize, rotation=90)
    axs.bar_label(rects6, fmt="%0.2f", padding=3, color=colors[5], fontsize=fontsize, rotation=90)
    axs.bar_label(rects7, fmt="%0.2f", padding=3, color=colors[6], fontsize=fontsize, rotation=90)
