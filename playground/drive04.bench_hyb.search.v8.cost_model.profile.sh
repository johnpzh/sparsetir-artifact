...
app="bench_suitesparse_spmm_hyb.search.v8.cost_model.profile.py"
...
verbose_file="${output_dir}/output_0_hyb_profile_verbose.log"
:> "${verbose_file}"
...
python "${app}" -f "${mtx_file}" -w "${new_max_width}" 2>&1 | tee -a "${verbose_file}"
