...
if __name__ == "__main__":
    ...
    NAME_FILE = "/home/peng599/pppp/vscode/sparsetir-artifact_mac/playground_v6_suitesparse/data/output.names.part4.txt"
    names_part = []
    ...
    for name in names_part:
        ...
        if format == "CELL" and (name not in ["Stanford_Berkeley"]):
        # if True:
            # Use CELL format
