...
if __name__ == "__main__":
    ...
    NAME_FILE = "/home/peng599/pppp/vscode/sparsetir-artifact_mac/playground_v6_suitesparse/data/output.names.part2.txt"
    names_part = []
    ...
    # for name in ["AS365"]:
        ...
        if format == "CELL" and (name not in ["wiki-Talk"]):
        # if True:
            # Use CELL format
            ...
            for num_features in [32, 64, 128, 256, 512]:
                ...
                exe_time = math.inf
                try:
                    # if name not in ["proteins", "reddit", "AS365"]:
