...
if __name__ == "__main__":
    ...
    NAME_FILE = "/home/peng599/pppp/vscode/sparsetir-artifact_mac/playground_v6_suitesparse/data/output.names.part1.txt"
    names_part = []
    ...
    for name in names_part:
        ...
        if format == "CELL" and (name not in ["pattern1"]):
        # if True:
            # Use CELL format
